...
public class CommentRepository {
    ...
    public void create(Comment comment) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LOG.warn("Comment creation fail for: " + comment.getComment());
            e.printStackTrace();
        }
        AuditLogger.getAuditLogger(CommentRepository.class).audit("Comment creation for: " + comment.getComment());
    }
    ...
    public List<Comment> getAll(int bookId) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LOG.warn("Failed comment fetch for id " + bookId);
            e.printStackTrace();
        }
        return commentList;
    }
